<?php
    ...
    //$cmd = mysql_connect('mysql-server-1.macs.hw.ac.uk', 'plo1', 'mysql123') or die('Could not connect'.mysql_error());
    ...
    */
    ...
    /* STEPHANIE 2*/
    /*
    $cmd = mysql_connect('mysql-server-1.macs.hw.ac.uk', 'scn31', 'scn31') or die('Could not connect'.mysql_error());
    $cnx = mysql_select_db('scn31') or die('Could not select database'.mysql_error());
    */
?>
