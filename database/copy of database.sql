...
SET time_zone = "+00:00";
CREATE TABLE  Friend  idUser int(11) NOT NULL, idFriend  int(11) NOT NULL, accepted  int(11) NOT NULL, rejected  int(11) NOT NULL, new  int(11) NOT NULL, date  DATETIME NOT NULL, PRIMARY KEY ( idUser , idFriend ), KEY  fk_2  ( idFriend )) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
